...
def bfs(v):
    queue = deque([v])
    red_v, blue_v = v
    visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][0] = 1

    while queue:
        red_v, blue_v = queue.popleft()
        if visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][0] > 11:
            return -1
        elif matrix[red_v[0]][red_v[1]] == 'O':
            return f"{visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][0] - 1}\n{visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][1]}"
        for i in range(4):
            ...
            if matrix[next_blue[0]][next_blue[1]] != 'O':
                if next_red == next_blue:
                    if red_distance < blue_distance:
                        ...
                        next_red = (next_red[0] - dy[i], next_red[1] - dx[i])
                if not visited[next_red[0]][next_red[1]][next_blue[0]][next_blue[1]][0]:
                    visited[next_red[0]][next_red[1]][next_blue[0]][next_blue[1]][0] = visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][0] + 1
                    visited[next_red[0]][next_red[1]][next_blue[0]][next_blue[1]][1] = visited[red_v[0]][red_v[1]][blue_v[0]][blue_v[1]][1] + d[i]
